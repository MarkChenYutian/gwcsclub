...
<div class="horizontal-flex-box">
    ...
    >
        ...
        <div class="horizontal-flex-box">
            ...
            <img class="mainPage-img" src="/assets/compass.png" height="25%" width="25%"/>
        </div>
    </div>
    <div class="flex-page-card" onClick="window.location.href='{{ site.baseurl }}/secondary-pages/2021/03/04/notes.html'">
        ...
        <div class="horizontal-flex-box">
            ...
            <img class="mainPage-img" src="/assets/notes.png" height="25%" width="25%"/>
        </div>
    </div>
    <div class="flex-page-card" onClick="window.location.href='{{ site.baseurl }}/secondary-pages/2021/01/26/Competitions.html'">
        ...
        <div class="horizontal-flex-box">
            ...
            <img class="mainPage-img" src="/assets/competition.png" height="25%" width="25%"/>
    ...
    <div class="flex-page-card" onClick="window.location.href='{{ site.baseurl }}/secondary-pages/2021/01/26/Computer-Science-Plus.html'">
        ...
        <div class="horizontal-flex-box">
            ...
            <img class="mainPage-img" src="/assets/cs_plus.png" height="25%" width="25%"/>
        </div>
    </div>
