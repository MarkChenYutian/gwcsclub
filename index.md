...
<div class="horizontal-flex-box">
    <div class="flex-page-card" onClick="window.location.href='{{ site.baseurl }}/secondary-pages/2021/01/31/To-Beginners.html'">
        ...
        <div class="horizontal-flex-box">
            ...
            <img class="mainPage-img" src="{{ site.baseurl }}/assets/compass.png" height="20%" width="20%"/>
        </div>
    </div>
    <div class="flex-page-card" onClick="window.location.href='{{ site.baseurl }}/secondary-pages/2021/03/04/notes.html'">
        ...
        <div class="horizontal-flex-box">
            ...
            <img class="mainPage-img" src="{{ site.baseurl }}/assets/notes.png" height="20%" width="20%"/>
        </div>
    </div>
    <div class="flex-page-card" onClick="window.location.href='{{ site.baseurl }}/secondary-pages/2021/01/26/Competitions.html'">
        ...
        <div class="horizontal-flex-box">
            ...
            <img class="mainPage-img" src="{{ site.baseurl }}/assets/competition.png" height="20%" width="20%"/>
    ...
    <div class="flex-page-card" onClick="window.location.href='{{ site.baseurl }}/secondary-pages/2021/01/26/Schedule.html'">
        ...
        <div class="horizontal-flex-box">
            ...
            <img class="mainPage-img" src="{{ site.baseurl }}/assets/schedule.png" height="20%" width="20%"/>
        </div>
    </div>
    <div class="flex-page-card" onClick="window.location.href='{{ site.baseurl }}/secondary-pages/2021/01/26/Computer-Science+.html'">
        ...
        <div class="horizontal-flex-box">
            ...
            <img class="mainPage-img" src="{{ site.baseurl }}/assets/cs+.png" height="20%" width="20%"/>
        </div>
    </div>
